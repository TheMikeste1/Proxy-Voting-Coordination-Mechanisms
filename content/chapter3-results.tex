...
\com{Explain why this happens.  Explain figure 3.1.  I'm assuming the colors don't mean anything?}
...
\com{Lots of zeroes in comparison.  Even the non-zeroes are very near zero. Maybe I don't know what I'm seeing.  If a 0 links the types, is there a statistical difference?}
...
\end{figure}
\com{Why is 31 the highest?  I'm not sure exactly how your test is set up.  How much lower error is significant? Number beaten seems to be a crude measure.  Looking at how others present their results would be an important sanity check.  How strong is your statistics background?}
...
averaging.  \com{Why is this?  If voters values are picked from a uniform distribution, it would seem average would be accurate.}
...
and \betadistribution{0.3}{0.3} as the inactive distributions.  \com{Has this beta distribution been defined in  your thesis?}
...
\com{This doesn't appear to match your previous discussion where you list all the ones better than weightlessly averaging.}
...
However, this benefit reduces over time \com{It isn't really over time is it?  It seems the value decreases with increased proxies.  If  you are weightlessly averaging all, why doesn't that get worse with more proxies?  Doesn't weightlessly averaging all, mean all voters or just all proxies?  Must mean the latter.} and eventually flattens out or, in the case
...
Additionally, there seems to be small `hiccups' at each whole number.  \com{I don't think this can be glossed over.  }
