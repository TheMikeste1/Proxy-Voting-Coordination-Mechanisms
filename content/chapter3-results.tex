...
Interestingly, however, is that the majority of most error populations are
...
circumstances where they are required and so they will still be examined to determine
...
distribution when weightlessly averaging as with the proxy system.
