...
\begin{enumerate}
    \item {
        Median ($L_1$), defined as $\input{content/figures/equations/weighted-median}$.
    ...
    \item {
        Mean ($L_2$), defined as $\input{content/figures/equations/weighted-mean}$.
        This is a typical weighted average.
    }
    \item {
        Mid-range ($L_\infty$), defined as
    ...
    \item {
        Plurality, defined as $\input{content/figures/equations/weighted-plurality}$,
        simply meaning the active voter with the highest weight.
...
% TODO: Replace this with a paragraph about proxy-constituent deliberation
