...
some other similar operation, all preferences can be aggregated with any desired voting
mechanism.
The resulting value will be the actual value, as estimated by the system.
