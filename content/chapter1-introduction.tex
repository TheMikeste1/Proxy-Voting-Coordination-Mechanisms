...
%
\com{Doesn't make sense for the House case.}
...
\com{I'm going to stop reading here until I hear back from you about the new
application. The application selected colors all other decisions.}
