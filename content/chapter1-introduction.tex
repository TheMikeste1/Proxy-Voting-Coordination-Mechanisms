...
$\truthof{\agent_5} = 0.15$.
Further details on such a preference space model and its mechanics is described in
...
%
We employ several common voting mechanisms and adapts them to the proxy voting system.
