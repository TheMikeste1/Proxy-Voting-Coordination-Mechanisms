...
Modeling voters' preferences in such as way allows for continuous preferences instead of
...
participation, this study will preselect proxies and require agents that are not
proxies to make use of them.
This allows the a system designer to choose a suitable set of measurement techniques
as the proxies, and reinforce their measurements using the other agents.

With all this in mind, the system proposed in this study operates like so:
A measurement is taken, and the resulting value subsequently represented as the
