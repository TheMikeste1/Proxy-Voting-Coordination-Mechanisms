...
{Cohensius2017  \com{No need to give paragraph.  You are mainly giving credit for the idea.  You can't give Cohesius credit for the idea of proxy voting.}
...
techniques.
{This makes total sense to me, in not employing sensors if they appear not to be needed.  If all the cheap sensors agree, is there really any point in employing an expensive sensors.  But is this really proxy voting?  It seems more like "not voting", as the expensive sensor has no opinion. }
