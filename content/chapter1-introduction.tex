...
While the type of proxy voting in Congress is not the traditional type of proxy vote
and instead is more similar to voting remotely, similar to how one might attend a
...
\section{Assumptions and Preliminary Setup}\label{sec:assumptions-and-preliminaries}
