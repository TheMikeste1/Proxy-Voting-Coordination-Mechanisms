...
Additionally, Miller did not consider using proxy voting for use by members of Congress,
which we will explore in this paper.

\etal{Cohensius}~\cite{Cohensius2019} explore the use of proxy voting in a metric space
...
symmetrical and asymmetrical preference distributions, and under both random and
