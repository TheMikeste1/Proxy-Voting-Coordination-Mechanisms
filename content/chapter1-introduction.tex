...
\vicki{Would be good to clarify why they can't just vote remotely.}
...
\vicki{I wonder how reasonable this assumption is.  It isn't likely they would pick someone of a different party.}
...
\vicki{ Better to pick another topic as feeling passionate about proxy voting in the discussion of proxy voting adds unnecessary confusion.}
...
\vicki{I would think it is better explained as multi-faceted topics.  For example, in seeking a solution to migration how do they feel about border restrictions, finding root causes of migration, economic impact.}
...
\vicki{For budget, any amount would be possible, but for other topics a complete range wouldn't be possible.  If you are voting on term limits, it really is a  yes/no decision.}
...
\vicki{In the house, we aren't trying to save them work in becoming knowledgeable.
I don't think they would like that connotation.  "I was too lazy to become informed so I gave my proxy to XXX."  Emphasize legimate reasons for needing a proxy:  illness, attend conference, spend time with sick relatives }
...
\vicki{be clear you are talking about proxy voting.  Abstaining is another way of being inactive.}
...
\vicki{This is a valid reason for proxy voting, but it isn't the reasons we are talking about here.}
...
\vicki{Strategic voting always requires information.  a5 could very well know how likely it was for others to select a proxy and could know their opinion.}
