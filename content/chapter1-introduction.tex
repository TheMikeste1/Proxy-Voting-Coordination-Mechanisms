...
\begin{itemize}
    ...
    \item {
        Weight by Ranked Choice, where the weight of an active voter is determined by
        ...
        This means the active voter in first will receive a system weight of $n$,
        regardless of its total delegator weight, and the active voter in last will
        receive a system weight of 1.
    }
