...
% TODO: Rewrite this paragraph for the new topic
...
must be overcome.  \com{Pick an application area and discuss the advantages of proxy
voting for them. The cost of remaining educated indicates the person doesn't have a
researched opinion. That is quite different from not being able to vote because of
inconvenience. In many cases, we want the voters to be informed. If they aren't,
    there are reasons to discount their vote.}
...
papers investigating their viability, advantages, and disadvantages.  \com{Cite those
papers here.}
