...
There are two parameters that create the most distinction between agents: their vote
...
infinite, as well as applying new weighting mechanisms which will likely yield
different results.
...
the least votes is removed from the ranking process and given a weight of 1.
...
determine to what degree any proxy vote system improves on simply averaging the
agents' votes.

As for the final question, improvement on error will be graphed against the number of
