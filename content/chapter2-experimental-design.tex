...
This study experiments with a number of candidate mechanisms, including a median
mechanism as described by~\cite{Cohensius2017} as (with some symbolic changes)
\begin{equation}
    \textbf{md}(\agents) =
    \min\{\agent_i \in \agents \text{ s.t. }
...
number of agents below it as it has above it in value.
