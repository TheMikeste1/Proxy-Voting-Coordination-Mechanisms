\section{Assumptions}\label{sec:\chptindicator-assumptions}
...
and proceeds to allocate all their weight towards one vote  \vicki{Can be make this clearer by calling in "one selection" or some other term?} instead of relaying their
constituents' vote.
...
the advantages of proxy voting that the relay-style does not provide.  \vicki{Not clear why there are advantages to proxy voting over relay-style.  Need to itemize those.}
