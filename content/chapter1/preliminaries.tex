...
\begin{enumerate}
    \item {
        ...
        % 05/05/2023: \vicki{
        %   This definition seems weird to me.  What is j?  Why not start at 1 and sum from 1 to i?  Why go to a(i-1) and then add i?
        % }
    ...
    \item {
        ...
        % \vicki{
        %   This is awkward too.  You sometimes use S and sometimes Sp, but you don't
        %   need both. S is sufficient, as the ordering doesn't matter.
        % }
