...
the proxy.
This probability represents the odds the agent would delegate their weight to a proxy.
...
elections.
Additionally, our mechanisms will be different due the mechanisms they used not being
beneficial on a continuous preference space or with a small number of candidates, or
not working well with proxy voting.
...
\begin{table}[htbp]
    ...
    \centering
    \input{content/chapter1/figures/mathur-voting-mechanisms}
\end{table}
