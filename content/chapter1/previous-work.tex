...
% "Let others explain for you"
% - Continuous model | Bulteau, Cohensius, Zhang
%   - Bulteasu attacks many different problens
%   - Cohensius focusses on single-winner 1D continuous
%   - Zhang treats weight as a probability instead of a count
% - Tracking weight | Degrave
% - Aggregation in continuous space | Bulteau, Cohensius

% Other approaches
% - Aggregation in non-continuous space | Mathur

% Misc
% - Expert proxies | Miller, Mueller
% - Voting cycles; bargaining and enforcement | Fearon
