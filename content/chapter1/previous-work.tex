...
delegating proxies  \vicki{This sounds like the proxies delegate, but actually they are the ones delegated to.} , and created two methods to determine the weights of each proxy.
...
output of the system.\vicki{Won't you really use it as the mechanism by which a proxy aggregates the votes of its constituents, rather than the way the whole systems selects a winner?}
