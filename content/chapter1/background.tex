...
misallocated.
% 05/05/2023: \vicki{
%   define precisely.  If they want to vote for x and find a proxy who is voting for
%   x, explain how their vote gets misallocated.
%   At the heart of the problem, we need to understand WHY their vote isn't just relayed
%   and that we don't want to limit the delegate to not shifting their vote.
% }
% I've inserted the sentence below
...
% 05/05/2023: \vicki{
%   At this point in the paper, you still haven't indicated that the proxy doesn't
%   just relay the vote.
%   I think this needs to be stated early and justified.
% }
% I've rearranged the paragraphs. Hopefully it makes more sense now. We have had this
% problem before though, where it's not possible to explain all the particulars of a
% topic before referencing it. Hopefully by introducing it in this paragraph and
% defining it in the next we solve this issue.
...
% 05/05/2023: \vicki{
%   This seems trivial.
%   The proxy already has to know who they vote for.
%   Knowing how they vote is only double the information - not a big deal.
% }
% Added more reasons as to why it's complex. The next sentences also outline
% additional reasons as to why relay voting may not be desirable.
