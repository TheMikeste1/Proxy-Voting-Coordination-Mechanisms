...
excellent avenue \vicki{not universally accepted as excellent} through which the agent can still have its voice heard and reduce
...
If the proxy is only allowed to cast one vote \vicki{Possibly confusing.  Their vote has a weight of more than one but there is one opinion represented.  At this point in the paper, the reader doesn't know the options.  Is there a way we can distinguish between casting one vote and having a weight of one?}   on behalf of all its constituents, those
...
as they want, but comes with the obvious downside \vicki{Is this really a downside? Seems to be an acceptable cost.}  that each proxy has to keep track
