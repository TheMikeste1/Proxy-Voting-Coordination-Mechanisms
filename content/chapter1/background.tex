...
constituents would not. \vicki{At this point in the paper, you still haven't indicated that the proxy doesn't just relay the vote.  I think this needs to be stated early and justified.}

Additionally, there are multiple ways a proxy voting system can allow its proxies to
vote.
...
misallocated.  \vicki{define precisely.  If they want to vote for x and find a proxy who is voting for x, explain how their vote gets misallocated.  At the heart of the problem, we need to understand WHY their vote isn't just relayed and that we don't want to limit the delegate to not shifting their vote.}
