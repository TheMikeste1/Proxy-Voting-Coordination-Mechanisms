...
ability to swing the system by aggregating a large amount of weight and abusing it.  \vicki{Not clear what the abuse refers to. 
 They got the weight fairly.  Is the abuse in threatening to change the preference for all?  Not all aggregation methods would permit abuse???}
...
interesting due to there not being any proxies.  \vicki{I thought you did consider 0?}
...
increase until all but one agent is inactive.  \vicki{Earlier you said 22 is the maximum}
