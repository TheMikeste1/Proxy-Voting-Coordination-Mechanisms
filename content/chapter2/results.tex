...
\autoref{fig:vm-col-cm-hue-error-as-percent-of-space-abs-mean}.\vicki{We need to know how the proxies work  You gave us several choices, but we can't map them to the choices shown here.  Also, how many total voters are there? }
...
\end{landscape}
      ...
      \vicki{The number of delegators makes no sense if we don't know the number of voters.  The caption should make it clear.}
...
\vicki{Not sure what you are saying in the preceding sentence.}
...
voting, does not work quite as well when agents have stronger, opposing opinions.  \vicki{This seems like a very common case.  Can you clarify why it doesn't work?
This may be your most important contribution, as  otherwise you are saying proxy works great and it doesn't matter how you do it.}
...
\end{figure}
  ...
  \vicki{all y axis values should be on the same scale for the same figure.
        %
        This figure is impossible to read as it is too small.  Need a better way of presenting.}
...
deliberations.  \vicki{It seems unrealistic to think there are huge swings in preference.}
