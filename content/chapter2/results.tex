...
voting mechanisms quickly increase  \vicki{quickly increase in error? explain.  This is interesting as more delegators slows the affect. 
 Better if x axis goes to 100\% as the other tables do.} before beginning to level out.
...
\begin{landscape}
    \begin{figure}[p]
        ...
        \caption{
            ...
            The plots have been smoothed to reduce the impact the dip in error that
            occurs around 90\% delegators has on the plots.
            The results are averaged over 1024 total runs.
            There are 24 total agents.
        }
