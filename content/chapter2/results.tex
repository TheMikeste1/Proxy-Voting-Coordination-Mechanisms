...
\vicki{Unclear.  Isn't this always the case with median, regardless of how many inactive voters?}
...
% TODO: Highlight this more. Why would we want a penalty? Add more research into
%   future work
...
\vicki{I would guess you would see more problems with the median, as the median cannot be accurately determined when they vote as a block.  If this is the case, it should be identified.  In general, median is considered better as it isn't manipulable.} 
...
which ultimately is a very small amount. \vicki{Make sure it is clear that this is percent not a fraction.}
