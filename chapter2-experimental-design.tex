...
% time?}
\vicki{This is interesting. How doesn't this impact your conclusions?}
...
\vicki{This may make more sense if we were using the expert voters periodically.
...
\vicki{Would be easier to follow if you described one system completely before talking
...
These extents are not meant to be known \vicki{ can you just say they are not known ?}
...
\vicki{Coehnsius didn't invent the term. Give proper credit.}
...
\systemtruth.  \vicki{Select a single proxy?}
...
\vicki{Briefly explain the median mechanism.}
...
number of agents below it as it has above it in terms of \agenttruth.  \vicki{this
...
provides the Borda count system.  \vicki{Need to briefly describe Borda. Not everyone
...
ranks each proxy on behalf of the agents according to distance \vicki{from their
preferred choice}.
...
time that proxy is selected as \systemtruth.  \vicki{How interesting is instant runoff
...
\vicki{Average seems like a bad name as average and mean are typically the same thing.
...
\vicki{I don't understand this one. Are we saying that it doesn't matter how many
...
\end{align}
\vicki{Picking the truth to be 0 is undesirable as your voting system could be biased
