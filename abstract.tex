...
% is indented properly. Max 350 words.
    ...
    of the vote.
    \vicki{Explain what the concern is.  If the proxy is just voting for/against, the concern isn't clear.Is it because the proxy extends to other issues like amendments, etc?}
    In this study, we give proxy voting its best chance\vicki{explain} 
    and explore its effects on
    ...
    Finally, we attempt to determine under which circumstances, if any, proxy voting should be
    used and identify strengths and weaknesses of using proxy voting in the
