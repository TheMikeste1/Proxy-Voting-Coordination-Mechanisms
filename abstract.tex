...
% is indented properly. Max 350 words.
    ...
    Finally, we attempt to determine under which circumstances, if any, proxy voting
    should be used and identify strengths and weaknesses of using proxy voting in the
