...
\usepackage[outdir=./content/figures/]{epstopdf} % To control where figures are output
...
\begin{document}
    ...
    \include{content/frontmatter/publicabstract}
...
%    \include{acknowl}     % optional TODO: Do I want acknowledgements?
    ...
    % Chapters
    \include{content/chapter1-introduction}
    \include{content/chapter2-experimental-design}
    \include{content/chapter3-results}
    \include{content/chapter4-conclusions-and-further-work}
...
%    \include{vita}  % TODO: I don't think I actually need this unless I'm a doctorate.
    %}}}
\end{document}
