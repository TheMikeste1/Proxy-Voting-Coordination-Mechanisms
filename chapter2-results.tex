...
\begin{document}
    ...
    Proxy voting is a method by which participants are able to have others vote on their \vicki{Not clear what "their" refers to}
    behalf.
    ...
    \input{content/chapter2/background}
    \input{common/preliminaries}
    \input{content/chapter2/assumptions}
    \input{content/chapter2/contribution}
