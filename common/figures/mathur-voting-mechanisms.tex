\begin{tabular}{| r | p{0.80\linewidth} |}
    ...
    \hline
    Schulze & {
        Agents rank the candidates and are allowed to skip rankings, give the same rank
